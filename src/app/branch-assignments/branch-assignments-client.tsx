...
export default function BranchAssignmentsClient({ user, permissions, leads, branches }: { user: ClientUser | null, permissions: string[], leads: ClientSalesLead[], branches: ClientBranch[] }) {
