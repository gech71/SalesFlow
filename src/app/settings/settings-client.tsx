      ...
      <Sidebar collapsible="icon">
        ...
        <SidebarContent>
            <SidebarMenu>
                ...
                {canViewSettings && (
                    <SidebarMenuItem>
                        <Link href="/settings"><SidebarMenuButton tooltip="Settings" isActive><Icons.settings /><span>Settings</span></SidebarMenuButton></Link>
                    </SidebarMenuItem>
                )}
            </SidebarMenu>
        </SidebarContent>
        <SidebarFooter>
            ...
            <SidebarMenu className="p-2">
                ...
                <SidebarMenuItem>
                    <form action={logoutAction} className="w-full"><SidebarMenuButton type="submit" className="w-full" tooltip="Logout"><Icons.logout /><span>Logout</span></SidebarMenuButton></form>
                </SidebarMenuItem>
            </SidebarMenu>
        </SidebarFooter>
      </Sidebar>
