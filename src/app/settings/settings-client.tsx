...
export default function SettingsClient({ offsiteDistanceThreshold }: { offsiteDistanceThreshold: number }) {
  ...
  useEffect(() => {
    reset({ threshold: offsiteDistanceThreshold });
  }, [offsiteDistanceThreshold, reset]);

  const onSubmit = async (data: z.infer<typeof settingsSchema>) => {
    try {
        await updateSetting({
            key: 'offsiteDistanceThreshold',
